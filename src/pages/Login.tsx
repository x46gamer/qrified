    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center px-4 py-12">
      ...
      <Card className="w-full max-w-md bg-white/80 backdrop-blur-sm border border-gray-100 shadow-xl transition-all animate-fade-in">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-xs text-center text-gray-500">Demo Logins (For Testing)</p>
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-4">
              <Button 
                onClick={() => handleDemoLogin('admin')}
                className="flex-1 bg-blue-100 text-blue-700 hover:bg-blue-200 border-none"
                size="sm"
                type="button"
              >
                Demo Admin
              ...
              <Button 
                ...
                className="flex-1 bg-purple-100 text-purple-700 hover:bg-purple-200 border-none"
                size="sm"
                type="button"
              >
                Demo Employee
