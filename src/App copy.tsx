...
import { QrCode, Menu, X, Shield, Lock, Key, Eye, Zap, CheckCircle, Activity, MapPin, BarChart, AlertTriangle, Fingerprint, Check, XCircle, Twitter, Linkedin, Facebook, Instagram, Github } from 'lucide-react';
...
const SecuritySection: React.FC = () => {
  ...
  return (
    ...
    >
      <ParallaxLayer speed={0.2} direction="left" className="absolute top-20 -right-20 w-64 h-64 rounded-full bg-primary-50 opacity-60 blur-3xl z-0">
        <div />
      </ParallaxLayer>
      <ParallaxLayer speed={0.3} direction="right" className="absolute bottom-40 -left-20 w-80 h-80 rounded-full bg-accent-50 opacity-60 blur-3xl z-0">
        <div />
      </ParallaxLayer>
